                        ...
                        <div class="col-md-12">
                            ...
                            {{-- <div class="blog-pagination">
                                <div class="btn-toolbar justify-content-center mb-15">
                                    <div class="btn-group">
                                        <a href="#" class="btn btn-primary prev"><i class="fa fa-angle-double-left"></i></a>
                                        <a href="#" class="btn btn-primary">2</a>
                                        {{-- <span class="btn btn-primary current">3</span> --}}
                                        {{-- <a href="#" class="btn btn-primary active">4</a>
                                        <a href="#" class="btn btn-primary next"><i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div> --}}
                            {{ $getPost->links() }}

                            ...
                            <tr>
                                ...
                                <td>
                                    @if($post->status == 'publish')
                                        <a href='{{ url('/edit_post_status' , ['type' => 'user' ,'id' => $code->encrypt($post->id)])}}' title="View details" class="btn btn-sm btn-warning ">
                                            Draft</i>
                                        </a>
                                    @else
                                        <a href='{{ url('/edit_post_status' , ['type' => 'user' ,'id' => $code->encrypt($post->id)])}}' title="View details" class="btn btn-sm btn-success ">
                                            Publish</i>
                                        </a>
                                    @endif
                                    <a href='{{ url('/edit_post' , ['type' => 'user' ,'id' => $code->encrypt($post->id)])}}' title="View details" class="btn btn-sm btn-info ">
                                        Edit</i>
                                    </a>
                                    <a  href='{{ url('/delete_post' , ['type' => 'user' ,'id' => $code->encrypt($post->id)])}}' title="Edit details" class="btn btn-sm btn-danger">
                                        Remove</i>
                                    </a>
                                </td>

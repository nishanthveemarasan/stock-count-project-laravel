...
@section('content')
    <div class="min-height-200px">
        ...
        <form action="{{url('mass_update_comment' , ['type' => 'all'])}}" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($comment->status == 'approve')
                                        <a href='{{ url('/edit_comment_status' , ['type' => 'all' , 'id' => $code->encrypt($comment->id)])}}' title="View details" class="btn btn-sm btn-warning ">
                                            Disable</i>
                                        </a>
                                    @else
                                        <a href='{{ url('/edit_comment_status' , ['type' => 'all' , 'id' => $code->encrypt($comment->id)])}}' title="View details" class="btn btn-sm btn-success ">
                                            Enable</i>
                                        </a>
                                    @endif
                                    <a  href='{{ url('/delete_comment' , ['type' => 'all' ,'id' => $code->encrypt($comment->id)])}}' title="Edit details" class="btn btn-sm btn-danger">
                                        Remove</i>
                                    </a>
                                </td>
